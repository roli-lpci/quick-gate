...
> **Repo `quick-gate-js`, npm package `quick-gate`.** The repository is named `quick-gate-js`; it publishes to npm as the package `quick-gate`, so install it with `npm install -g quick-gate`.
